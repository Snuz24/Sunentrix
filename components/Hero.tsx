...
const rotatingLines = [
  "Features don't sell AI products. Stories do.",
  "AI products deserve better marketing.",
...
export default function Hero() {
  ...
  useEffect(() => {
    const id = setInterval(() => setIndex((i) => (i + 1) % rotatingLines.length), 3600);
    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-6 pt-28 pb-20">
      ...
      <div className="relative max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 lg:gap-16 items-center">
        ...
        <div className="max-w-2xl">
          ...
          >
            Helping AI Companies Turn Complex Products Into Stories{" "}
            <span className="text-gradient-accent">People Remember.</span>
          </motion.h1>
          ...
          <motion.div
            ...
            className="h-6 flex items-center mb-6 overflow-hidden"
          >
          ...
          <motion.p
            ...
            className="text-[16px] sm:text-[17.5px] leading-relaxed text-text-secondary mb-10 max-w-xl"
          >
            We're a boutique studio creating product demos, founder stories, and educational content that help AI companies increase product adoption, build trust, and turn curiosity into committed users.
          </motion.p>
